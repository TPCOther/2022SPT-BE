 ...
 * @LastEditTime: 2022-06-30 16:21:41
...
public class DepartmentController {
    ...
    public RBody updateDepartment(@RequestBody Department department)
    {
        ...
        try {
            baseExecution=this.departmentService.updateDepartment(department);
            rBody=RBody.ok();
        } catch (Exception e) {
    ...
    public RBody deleteDepartment(@RequestBody Department department)
    {
        ...
        BaseExecution<Department> baseExecution=new BaseExecution<>();
        try {
            baseExecution=this.departmentService.deleteDepartment(department);
            rBody=RBody.ok();
        } catch (Exception e) {
            rBody=RBody.error(e.toString());
        }
